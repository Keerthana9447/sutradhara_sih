...
_AREA_KEYWORDS = {
    "Patents": ["patent", "patentable", "invention", "novelty", "inventive step", "pct", "international patent application", "microorganism deposit", "micro-organism deposit", "microbial strain", "budapest treaty", "genetic resources disclosure", "country of origin disclosure", "gratk"],
